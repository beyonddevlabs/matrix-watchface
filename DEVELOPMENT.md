...
Technische Seite des Matrix Watchface. Die Anwender- und Installationsseite
...
Schwarzer Grund und eine einzige grüne Farbe sind auf AMOLED der günstigste
...
- **Farbformat.** `@zos/ui` bekommt Farben als einfache Zahl (`0x00ff41`), so
